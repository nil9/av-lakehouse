...
LOCAL_DEFAULTS = StoragePathConfig(
    ...
    gold_ai_output_path="data/gold_plus/ai_compatible_export",
)
...
def load_storage_path_config() -> StoragePathConfig:
    return StoragePathConfig(
        ...
        gold_ai_output_path=os.getenv(
            "GOLD_AI_OUTPUT_PATH", LOCAL_DEFAULTS.gold_ai_output_path
        ),
    )
